...
public class Queen extends Piece {
    ...
    public void move(int coordinate) {
        if ((coordinate - this.coordinate % 10 == 0 || coordinate - this.coordinate < 8 || coordinate - this.coordinate % 9 == 0 || coordinate - this.coordinate % 11 == 0) && ) { // TODO: only allow movement if there are no pieces inbetween)
